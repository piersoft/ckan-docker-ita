...
Uso nei template:  {% set mqa = h.dcatapit_edp_mqa(pkg) %}
"""
...
KEY_PREFIX = 'dcatapit:edp_mqa:v2:'
BREAKER_KEY = 'dcatapit:edp_mqa:breaker'

HEADERS = {'Accept': 'application/json', 'User-Agent': 'CKAN dcatapit edp_mqa'}
